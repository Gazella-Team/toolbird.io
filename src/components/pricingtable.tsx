	...
	return (
		<section className="mb-24 mt-6">
			<div className="grid grid-cols-1 lg:grid-cols-3 mx-auto max-w-6xl w-[86%] gap-14 lg:gap-6">
				<div
					className="bg-white relative rounded-3xl border border-gray-600/10 text-gray-800 shadow-clean"
				>
					<div>
						...
						<div className="bg-slate-50 border-y py-5 px-7 border-gray-600/10">
							<div className="flex">
								<Link
									...
									className="bg-gray-800 text-center paragraph w-full border-[3px] border-gray-800 text-sm font-medium text-white px-6 py-2 rounded-full"
								>
