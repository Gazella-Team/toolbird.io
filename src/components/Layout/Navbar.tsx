...
export default function Navbar(props:any) {
    return (
        ...
        <div className="w-[96%] max-w-[1470px] mx-auto text-gray-800 flex items-center justify-start">
            <div className="w-[25%]">
                <Link href={"/"} >
                    <img className="w-[100px]" src="/logos/logograytext.svg"></img>
                </Link>
            </div>
            <div className="flex-1 flex items-center text-[15px] justify-center gap-[30px] font-[400]">
