    ...
    <nav className="h-[80px] flex items-center bg-transparent">
      <div className="w-[95%] mx-auto max-w-[1400px] flex items-center justify-between text-gray-800">
        ...
        <div className="flex items-center justify-center gap-8">
          ...
          <Flyout triggerName="Company" heading="Every tool needed" links={[{name:"News", href:"/news", description: "Create and share your waitlist with 2 clicks"}, {name:"About", href:"/", description: "Create and share your waitlist with 2 clicks"}, {name:"Waitlists", href:"/", description: "Create and share your waitlist with 2 clicks"}, {name:"Waitlists", href:"/", description: "Create and share your waitlist with 2 clicks"}]} />
