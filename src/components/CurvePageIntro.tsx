...
export default function CurvePageIntro(props: CurvePageIntroProps) {
	return (
        <>
        <section className="py-[50px] pt-[60px] sm:pt-[80px] bg-[url(/curve.svg)] bg-center bg-cover min-h-[540px] sm:min-h-[600px]">
