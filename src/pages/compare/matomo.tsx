...
export default function ComparePlausible() {
	return (
		<Layout whiteBeforeScroll={true} noCta={true} white={true}>
			<Meta title={`Toolbird vs Matomo: The #1 Matomo Alternative`} />
			<CurvePageIntro
				hook="The #1 Matomo Alternative"
				highlighted=""
				heading="Toolbird vs Matomo"
				paragraph="Looking for the best Matomo Alternative? See why others prefer using Toolbird."
			>
