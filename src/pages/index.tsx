...
export default function Home() {
  return (
    <Layout mode="">
      <MainHero heading="Introducing ToolBird Guides" paragraph="Wake up to an inbox full of new testimonial alerts. Share them everywhere in seconds. Get more visits, convert more, and close more deals. Senja makes it easy." />
      <section>
