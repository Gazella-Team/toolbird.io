...
export default function FastSetup() {
	return (
			...
			>
				<div className="w-[86%] text-gray-800 flex flex-col gap-10 paragraph mx-auto max-w-xl">
					<h2 className="text-4xl font-semibold">
						Toolbird: Get started with web analytics in a few minutes.
					</h2>
					<div>
						<p className="text-gray-600">
							One of the use cases Plausible Analytics was
							specifically designed for are the freelancers and
							agencies who work with clients developing their
							websites, communication and marketing practices.
							<br></br>
							<br></br>A regular task when working on a website
							for a client is to install some kind of website
							statistics and reporting solution. And Google
							Analytics is the most popular web analytics
							solution.
						</p>
					</div>
